using AutoServiceManager.API.Controllers;
using AutoServiceManager.Application.Features.Products.Commands.Create;
using AutoServiceManager.Application.Features.Products.Commands.Delete;
...
namespace AutoServiceManager.Api.Controllers.v1
{
